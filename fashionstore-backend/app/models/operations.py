...
class Facility(Base):
    ...
    reservations: Mapped[list["FacilityReservation"]] = relationship(back_populates="facility", cascade="all, delete-orphan")
...
class MaintenanceTask(Base):
    ...
    description: Mapped[str | None] = mapped_column(Text, nullable=True)
    facility_id: Mapped[int | None] = mapped_column(ForeignKey("facilities.id", ondelete="SET NULL"), nullable=True, index=True)
    assignee_id: Mapped[int | None] = mapped_column(ForeignKey("usuario.id", ondelete="SET NULL"), nullable=True, index=True)
